...
public class Constants {
  ...
  public static final String EVENT_TAIL_CONF_PATH = "/data/log/event16repairconfig";
  ...
  public static final String USER_TAIL_CONF_PATH = "/data/log/user16repairconfig";


  //  public static final String USER_LOAD_PATH = "/data/log/userload/
  public static final String USER_LOAD_PATH = "/data/log/user16repairload/";
  ...
  public static final int MYSQL_BL_THREADS = 50;
